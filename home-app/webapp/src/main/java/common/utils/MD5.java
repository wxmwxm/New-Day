...
public class MD5 {
	 ...
	 */
	public String getMD5ByString(String inbuf) {
		md5Init();
	...
	public String getMD5ofStr_s(String inbuf)
	  {
	    md5Init();
	    md5Update(inbuf.getBytes(), inbuf.length());
	    md5Final();
	 ...
	 * �?��为java中的byte的toString无法实现这一点，我们又没有C语言中的 sprintf(outbuf,"%02X",ib)
	 */
	...
	public static void main(String args[]) {
		MD5 md5 = new MD5();
		String str000000 = "000000";
		String str123456 = "123456";
		String str111111 = "111111";
		System.out.println(" 000000 = "+md5.getMD5ByString(str000000));
		System.out.println(" 123456 = "+md5.getMD5ByString(str123456));
		System.out.println(" 111111 = "+md5.getMD5ByString(str111111));
	}
}
