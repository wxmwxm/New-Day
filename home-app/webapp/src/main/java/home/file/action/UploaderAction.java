...
public class UploaderAction extends BaseAction{
	...
	public void upload() throws Exception {
		...
		result.put("name",this.getFileName());
		result.put("originalName",this.getOriginalName());
		result.put("size",this.getSize());
		result.put("state",getState());
		result.put("type",this.getType());
		result.put("url",this.getUrl());
		writeJson(result);
//		"{\"name\":\""+ up.getFileName() +"\", \"originalName\": \""+ up.getOriginalName() +"\", \"size\": "+
//		up.getSize() +", \"state\": \""+ up.getState() +"\", \"type\": \""+ up.getType() +"\", \"url\": \""+ up.getUrl() +"\"}
	}
	...
	public void uploadBase64(String fieldName){
		String savePath = this.getFolder(this.savePath);
		String base64Data = getRequest().getParameter(fieldName);
